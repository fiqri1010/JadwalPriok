...
import { checkAndSendPiketReminders } from './lib/piketNotification';
import { getWidgetShiftData } from './lib/androidWidgetSync';
...
export default function App() {
    ...
    // Otomatis sinkronkan data ke Android Widget & Periksa Notifikasi Piket (H-1 & 06:00 pagi)
    useEffect(() => {
        getWidgetShiftData(daysState);
        checkAndSendPiketReminders(daysState, daftarLibur);
        ...
        <div className={themeConfig.wrapperClass}>
                ...
                <header className={themeConfig.navbarClass}>
                    <div className={`flex items-center justify-between py-1.5 sm:py-2 ${desktopContainerClass}`}>
                        ...
                        <div className="hidden sm:flex items-center space-x-1.5 sm:space-x-2">
                                    ...
                                    <>
                                        ...
                                        <div className={themeConfig.themeDropdownMenuClass}>
                                            ...
                                            <button
                                                ...
                                                className={`w-full flex items-center justify-between px-2.5 py-2 rounded-xl text-xs font-bold transition-colors cursor-pointer ${currentTheme === 'default' ? 'bg-[#2EC4B6]/20 text-[#2EC4B6]' : 'hover:bg-black/5 dark:hover:bg-white/5'
                                                    }`}
                                            >
                                            ...
                                            <button
                                                ...
                                                className={`w-full flex items-center justify-between px-2.5 py-2 rounded-xl text-xs font-bold transition-colors cursor-pointer ${currentTheme === 'dark' ? 'bg-slate-700 text-white' : 'hover:bg-black/5 dark:hover:bg-white/5'
                                                    }`}
                                            >
                                                <span className="flex items-center space-x-2">
                                            ...
                                            <button
                                                ...
                                                className={`w-full flex items-center justify-between px-2.5 py-2 rounded-xl text-xs font-bold transition-colors cursor-pointer ${currentTheme === 'vista' ? 'bg-sky-100 text-sky-800' : 'hover:bg-black/5 dark:hover:bg-white/5'
                                                    }`}
                                            >
                                                <span className="flex items-center space-x-2">
                                            ...
                                            <button
                                                ...
                                                className={`w-full flex items-center justify-between px-2.5 py-2 rounded-none text-xs font-bold font-mono transition-colors cursor-pointer ${currentTheme === 'winamp' ? 'bg-[#000000] text-[#00FF00] border border-[#00FF00]' : 'hover:bg-black/20 text-[#00FF00]'
                                                    }`}
                                            >
                                                <span className="flex items-center space-x-2">
                            ...
                            {/* 3. Tombol Sync & Simpan (Logo Only: Save + Lingkaran Sync) */}
                            <button
                                type="button"
                                onClick={handleSaveAndSync}
                                disabled={isSavingLocal || isSyncing}
                                title={isSyncing ? 'Sedang sinkronisasi dengan Cloud...' : isSavingLocal ? 'Menyimpan data lokal...' : 'Simpan Data & Sinkronisasi Cloud'}
                                className={themeConfig.syncBtnClass}
                                aria-label="Simpan dan Sinkronisasi"
                            >
                                <div className="relative inline-flex items-center justify-center">
                                    <Save className="h-4 w-4" />
                                    <span className="absolute -bottom-1 -right-1 flex h-2.5 w-2.5 items-center justify-center rounded-full bg-black/50 border border-white/40">
                                        <RefreshCw className={`h-1.5 w-1.5 text-white ${isSyncing ? 'animate-spin' : ''}`} />
                                    </span>
                                </div>
                            </button>
                        </div>
                    ...
                    <div className="flex items-center justify-between py-1.5 px-2.5">
                        ...
                        <div className="flex items-center space-x-1">
                            ...
                            >
                                ...
                                <span className="text-[10px]">Libur</span>
                            </button>
                    ...
                    <div className={themeConfig.viewSwitcherCardClass}>
                        <div className={themeConfig.viewSwitcherPillsWrapperClass}>
                            <button
                                ...
                                className={`flex items-center space-x-1.5 sm:space-x-2 rounded-lg px-2.5 sm:px-3.5 py-1 sm:py-1.5 text-xs font-black transition-all cursor-pointer ${pageTab === 'calendar'
                            ...
                            <button
                                ...
                                className={`flex items-center space-x-1.5 sm:space-x-2 rounded-lg px-2.5 sm:px-3.5 py-1 sm:py-1.5 text-xs font-black transition-all cursor-pointer ${pageTab === 'recap'
                                        ? themeConfig.tabActiveClass
                                        : themeConfig.tabInactiveClass
                                    }`}
                            >
                            ...
                            <button
                                ...
                                className={`flex items-center space-x-1.5 sm:space-x-2 rounded-lg px-2.5 sm:px-3.5 py-1 sm:py-1.5 text-xs font-black transition-all cursor-pointer ${pageTab === 'performance'
                                        ? themeConfig.tabActiveClass
                                        : themeConfig.tabInactiveClass
                                    }`}
                            >
                            ...
                            <button
                                ...
                                className={`flex items-center space-x-1.5 sm:space-x-2 rounded-lg px-2.5 sm:px-3.5 py-1 sm:py-1.5 text-xs font-black transition-all cursor-pointer ${pageTab === 'guide'
                                        ? themeConfig.tabActiveClass
                                        : themeConfig.tabInactiveClass
                                    }`}
                            >
                                ...
                                <div className="flex items-center space-x-1 sm:space-x-1.5 shrink-0">
                                    ...
                                    <button
                                        ...
                                        className={
                                            areAllLocked
                                                ? currentTheme === 'winamp'
                                                    ? 'flex items-center space-x-1.5 rounded-none border border-zinc-800 bg-black text-zinc-600 p-1.5 sm:px-2.5 sm:py-1 text-xs font-bold opacity-40 cursor-not-allowed shadow-none font-mono'
                                                    : 'flex items-center space-x-1.5 rounded-lg sm:rounded-xl border border-slate-300 dark:border-zinc-700 bg-slate-100 dark:bg-zinc-800/60 text-slate-400 dark:text-zinc-500 p-1.5 sm:px-2.5 sm:py-1 text-xs font-bold opacity-40 cursor-not-allowed shadow-none'
                                                : themeConfig.resetBtnClass
                                        }
                                        title={
                                            areAllLocked
            ...
            {isResetConfirmOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    />
                    <div className={`relative w-full max-w-md p-6 shadow-2xl border animate-in zoom-in-95 duration-200 ${currentTheme === 'winamp'
                        ...
                        <div className="flex items-center justify-end space-x-2.5">
                            <button
                                type="button"
                                onClick={() => setIsResetConfirmOpen(false)}
                                className={`px-4 py-2 text-xs sm:text-sm font-bold transition-colors cursor-pointer ${currentTheme === 'winamp'
                        ...
                        <div className="mt-4 space-y-2">
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                <button
                                    ...
                                    className={`flex items-center space-x-2 rounded-xl p-2.5 text-xs font-bold transition-colors ${pageTab === 'calendar'
                                ...
                                <button
                                    ...
                                    className={`flex items-center space-x-2 rounded-xl p-2.5 text-xs font-bold transition-colors ${pageTab === 'recap'
                                            ? 'bg-[#297373] text-white shadow-xs'
                                            : 'bg-slate-100 text-slate-700 hover:bg-slate-200'
                                        }`}
                                >
                                ...
                                <button
                                    ...
                                    className={`flex items-center space-x-2 rounded-xl p-2.5 text-xs font-bold transition-colors ${pageTab === 'performance'
                                            ? 'bg-[#297373] text-white shadow-xs'
                                            : 'bg-slate-100 text-slate-700 hover:bg-slate-200'
                                        }`}
                                >
                                ...
                                <button
                                    ...
                                    className={`flex items-center space-x-2 rounded-xl p-2.5 text-xs font-bold transition-colors ${pageTab === 'guide'
                                            ? 'bg-[#297373] text-white shadow-xs'
                                            : 'bg-slate-100 text-slate-700 hover:bg-slate-200'
                                        }`}
                                >
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                ...
                                {lastResetBackupState !== null ? (
                                    ...
                                    <button
                                        ...
                                        disabled={areAllLocked}
                                        className={`flex items-center space-x-2.5 rounded-xl border p-2.5 text-left text-xs font-bold ${areAllLocked
                                                ? 'border-slate-300 dark:border-zinc-700 bg-slate-100 dark:bg-zinc-800/60 text-slate-400 dark:text-zinc-500 cursor-not-allowed opacity-40 shadow-none'
                                                : 'border-rose-200 bg-rose-50 text-rose-800 hover:bg-rose-100'
                                            }`}
                                    >
                                        <RotateCcw className={`h-4 w-4 shrink-0 ${areAllLocked ? 'text-slate-400 dark:text-zinc-500' : 'text-rose-600'}`} />
                                ...
                                <div className="col-span-2 rounded-xl bg-slate-100 p-2 border border-slate-200">
                                    ...
                                    <div className="grid grid-cols-4 gap-1">
                                        <button
                                            ...
                                            className={`p-1.5 rounded-lg text-center text-[9.5px] font-bold transition-all ${currentTheme === 'default' ? 'bg-[#297373] text-white shadow-xs' : 'bg-white text-slate-700 hover:bg-slate-200'
                                                }`}
                                        >
                                            Default
                                        </button>
                                        <button
                                            ...
                                            className={`p-1.5 rounded-lg text-center text-[8.5px] font-bold transition-all ${currentTheme === 'dark' ? 'bg-slate-900 text-white shadow-xs' : 'bg-white text-slate-700 hover:bg-slate-200'
                                                }`}
                                        >
                                            Dark Mode (Alpha)
                                        </button>
                                        <button
                                            ...
                                            className={`p-1.5 rounded-lg text-center text-[8.5px] font-bold transition-all ${currentTheme === 'vista' ? 'bg-blue-600 text-white shadow-xs' : 'bg-white text-slate-700 hover:bg-slate-200'
                                                }`}
                                        >
                                            Vista (Alpha)
                                        </button>
                                        <button
                                            ...
                                            className={`p-1.5 rounded-lg text-center text-[8.5px] font-bold font-mono transition-all ${currentTheme === 'winamp' ? 'bg-zinc-900 text-emerald-400 shadow-xs' : 'bg-white text-slate-700 hover:bg-slate-200'
                                                }`}
                                        >
                                            Winamp (Beta)
                                        </button>
