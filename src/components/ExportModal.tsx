...
export const ExportModal: React.FC<ExportModalProps> = ({
    ...
    // 3. Ekspor PNG Screenshot Kalender
                ...
                <div className="my-4 rounded-2xl bg-slate-50 p-3.5 sm:p-4 border border-slate-200 space-y-3">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-1.5">
                        <button
                            ...
                            className={`px-2.5 py-1.5 rounded-xl text-xs font-bold transition-all border text-left cursor-pointer ${rangeType === 'month_active'
                        ...
                        <button
                            ...
                            className={`px-2.5 py-1.5 rounded-xl text-xs font-bold transition-all border text-left cursor-pointer ${rangeType === 'month_filled'
                                    ? 'bg-[#297373] text-white border-[#297373] shadow-xs'
                                    : 'bg-white text-slate-700 border-slate-200 hover:bg-slate-100'
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`px-2.5 py-1.5 rounded-xl text-xs font-bold transition-all border text-left cursor-pointer ${rangeType === 'quarter'
                                    ? 'bg-[#297373] text-white border-[#297373] shadow-xs'
                                    : 'bg-white text-slate-700 border-slate-200 hover:bg-slate-100'
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`px-2.5 py-1.5 rounded-xl text-xs font-bold transition-all border text-left cursor-pointer ${rangeType === 'semester'
                                    ? 'bg-[#297373] text-white border-[#297373] shadow-xs'
                                    : 'bg-white text-slate-700 border-slate-200 hover:bg-slate-100'
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`px-2.5 py-1.5 rounded-xl text-xs font-bold transition-all border text-left cursor-pointer ${rangeType === 'year'
                                    ? 'bg-[#297373] text-white border-[#297373] shadow-xs'
                                    : 'bg-white text-slate-700 border-slate-200 hover:bg-slate-100'
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`px-2.5 py-1.5 rounded-xl text-xs font-bold transition-all border text-left cursor-pointer ${rangeType === 'custom'
                                    ? 'bg-[#297373] text-white border-[#297373] shadow-xs'
                                    : 'bg-white text-slate-700 border-slate-200 hover:bg-slate-100'
                                }`}
                        >
                            ...
                            <div className="flex gap-1.5">
                                {[1, 2, 3, 4].map((q) => (
                                    <button
                                        ...
                                        className={`px-3 py-1 rounded-lg text-xs font-bold cursor-pointer transition-colors ${selectedQuarter === q
                        ...
                        <div className="pt-2 border-t border-slate-200/80 flex items-center gap-2">
                            ...
                            <div className="flex gap-1.5">
                                <button
                                    ...
                                    className={`px-3 py-1 rounded-lg text-xs font-bold cursor-pointer transition-colors ${selectedSemester === 1
                                            ? 'bg-[#297373] text-white'
                                            : 'bg-white border border-slate-200 text-slate-700 hover:bg-slate-100'
                                        }`}
                                >
                                ...
                                <button
                                    ...
                                    className={`px-3 py-1 rounded-lg text-xs font-bold cursor-pointer transition-colors ${selectedSemester === 2
                                            ? 'bg-[#297373] text-white'
                                            : 'bg-white border border-slate-200 text-slate-700 hover:bg-slate-100'
                                        }`}
                                >
