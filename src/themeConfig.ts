...
export function getThemeConfig(theme: AppTheme): ThemeConfig {
  ...
  if (isDark) {
    return {
      ...
      settingsBtnClass: 'flex items-center space-x-1.5 rounded-lg bg-[#2A2A2A] hover:bg-[#333333] px-2.5 py-1 sm:px-3 sm:py-1.5 text-xs font-bold text-[#E0E0E0] transition-colors cursor-pointer border border-[#444444] shadow-xs',
      syncBtnClass: 'flex items-center space-x-1.5 rounded-lg bg-[#2563EB] hover:bg-[#1D4ED8] px-2.5 py-1 sm:px-3 sm:py-1.5 text-xs font-bold text-white transition-colors cursor-pointer shadow-xs border border-blue-400/30',
  ...
  if (isVista) {
    return {
      ...
      settingsBtnClass: 'flex items-center space-x-1.5 rounded-lg bg-white/10 hover:bg-white/20 px-2.5 py-1 sm:px-3 sm:py-1.5 text-xs font-bold text-white transition-colors cursor-pointer border border-white/20 shadow-xs backdrop-blur-xs',
      syncBtnClass: 'flex items-center space-x-1.5 rounded-lg bg-sky-600/85 hover:bg-sky-700 px-2.5 py-1 sm:px-3 sm:py-1.5 text-xs font-bold text-white transition-colors cursor-pointer shadow-xs border border-sky-300/40 backdrop-blur-xs',
  ...
  if (isWinamp) {
    return {
      ...
      settingsBtnClass: 'flex items-center space-x-1.5 rounded-none bg-[#2D2E40] hover:bg-[#4A4D64] px-2.5 py-1 sm:px-3 sm:py-1.5 text-xs font-bold text-[#FACC15] transition-colors cursor-pointer border border-[#555555] font-mono shadow-none',
      syncBtnClass: 'flex items-center space-x-1.5 rounded-none bg-[#000000] hover:bg-[#00FF00] hover:text-black px-2.5 py-1 sm:px-3 sm:py-1.5 text-xs font-bold text-[#00FF00] transition-colors cursor-pointer shadow-none border border-[#00FF00] font-mono',
  ...
  return {
    ...
    settingsBtnClass: 'flex items-center space-x-1.5 rounded-lg bg-[#0d2a45] hover:bg-[#163e60] px-2.5 py-1 sm:px-3 sm:py-1.5 text-xs font-bold text-slate-200 transition-colors cursor-pointer border border-[#2EC4B6]/30 shadow-xs',
    syncBtnClass: 'flex items-center space-x-1.5 rounded-lg bg-[#20A4F3] hover:bg-[#198fd4] px-2.5 py-1 sm:px-3 sm:py-1.5 text-xs font-bold text-white transition-colors cursor-pointer shadow-xs border border-sky-400/40',
